...
class TestFirefoxNew(TestCase):
    ...
    #herz
    def test_variation_scene_1(self, render_mock):
    ...
    def test_variation_scene_2(self, render_mock):
    ...
    def test_variation_nonde_scene_1(self, render_mock):
        req = RequestFactory().get('/firefox/new/?xv=herz')
        req.locale = 'en-US'
        views.new(req)
        render_mock.assert_called_once_with(req, 'firefox/new/scene1.html', ANY)

    def test_variation_nonde_scene_2(self, render_mock):
        req = RequestFactory().get('/firefox/download/thanks/?xv=herz')
        req.locale = 'en-US'
        views.download_thanks(req)
        render_mock.assert_called_once_with(req, 'firefox/new/scene2.html')
    ...
    def test_variation_scene_1(self, render_mock):
        ...
        req.locale = 'de'
        views.new(req)
        render_mock.assert_called_once_with(req, 'firefox/new/berlin/scene1-speed.html', ANY)

    def test_variation_scene_2(self, render_mock):
        req = RequestFactory().get('/firefox/download/thanks/?xv=speed')
        req.locale = 'de'
        views.download_thanks(req)
        render_mock.assert_called_once_with(req, 'firefox/new/berlin/scene2-speed.html')
    ...
    def test_variation_scene_1(self, render_mock):
        ...
        req.locale = 'de'
        views.new(req)
        render_mock.assert_called_once_with(req, 'firefox/new/berlin/scene1-privacy.html', ANY)

    def test_variation_scene_2(self, render_mock):
        req = RequestFactory().get('/firefox/download/thanks/?xv=privacy')
        req.locale = 'de'
        views.download_thanks(req)
        render_mock.assert_called_once_with(req, 'firefox/new/berlin/scene2-privacy.html')
    ...
    def test_variation_scene_1(self, render_mock):
        ...
        req.locale = 'de'
        views.new(req)
        render_mock.assert_called_once_with(req, 'firefox/new/berlin/scene1-oys.html', ANY)

    def test_variation_scene_2(self, render_mock):
        req = RequestFactory().get('/firefox/download/thanks/?xv=oys')
        req.locale = 'de'
        views.download_thanks(req)
        render_mock.assert_called_once_with(req, 'firefox/new/berlin/scene2-oys.html')
